...
Since $X_1, \ldots, X_n$ are random sample (they are iid):
...
Where V is a pivotal quantity. 

The above cdf is from an Exponential distribution! So, $V \sim \text{Exponential}(1)$.

Further, let $q_p = -\log(1-p)$ denote the $p$-th quantile of the $\text{Exponential}(1)$ distribution.
...
Again, using $q_p$ for quantiles of the $\text{Exponential}(1)$ distribution. 
