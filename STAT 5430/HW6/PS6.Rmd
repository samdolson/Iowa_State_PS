...
(Side Note: The following is based on usage of language/ideas from Casella. After discussing with Dr. Nordman, the language preferred is to simply advance from "We have MLR" into the "(U)MP test of size $\alpha$". That being said, to elaborate further: "Importantly, the family having a MLR in $x$ allows us to utilize Karlin-Rubin, i.e. the test that rejects for large values of $X$ is UMP for $H_0: \theta \leq 1$ vs $H_1: \theta > 1$.")
