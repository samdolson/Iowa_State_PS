...
# 2000 x 256 
# rowmeans for mean of each row
# 2000 x 1 vector

ziptrainMeans <- rowMeans(ziptrain)
length(ziptrainMeans)

# replicate that vector 256 times 
...
# svd entire deviations matrix 

svdDiffD <- svdDiff$d
# pull out $d from that svd output 

k1 <- diag(c(svdDiffD[1:25], rep(0, 231)))
k2 <- diag(c(svdDiffD[1:50], rep(0, 206)))
k3 <- diag(c(svdDiffD[1:75], rep(0, 181)))

k1Mat <- svdDiff$u %*% k1 %*% t(svdDiff$v)
k2Mat <- svdDiff$u %*% k2 %*% t(svdDiff$v)
k3Mat <- svdDiff$u %*% k3 %*% t(svdDiff$v)

k1PlusMeanDiff <- k1Mat + ziptrainMeansRep
k2PlusMeanDiff <- k2Mat + ziptrainMeansRep
k3PlusMeanDiff <- k3Mat + ziptrainMeansRep
...
newK1 <- array(t(k1PlusMeanDiff), dim = c(16, 16, 2000))
...
newK2 <- array(t(k2PlusMeanDiff), dim = c(16, 16, 2000))
...
newK3 <- array(t(k3PlusMeanDiff), dim = c(16, 16, 2000))
