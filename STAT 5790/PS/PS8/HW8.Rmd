...
ksTests <- apply(X = z, 
                  MARGIN = 2, 
                  FUN = function(column) {
                    ks.test(column, "punif", min = -1, max = 1)
                    }
                  )
