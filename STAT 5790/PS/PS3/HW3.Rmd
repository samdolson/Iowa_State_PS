...
# )
# 
# compFor <- mutate(averageCountsperType, 
#                  resultsForInd
# )
# 
# compAgainst <- mutate(averageCountsperType, 
#                  resultsAgainstInd
# )
```
...
mSenateNeutral <- as.matrix(resultsNeutralInd[,2:100], nrow = 36, ncol = 99)
mSenateFor <- as.matrix(resultsForInd[,2:100], nrow = 36, ncol = 99)
mSenateAgainst <- as.matrix(resultsAgainstInd[,2:100], nrow = 36, ncol = 99)
