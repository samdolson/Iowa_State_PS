...
#     )
#   }, error = function(e) {
#     # extrra failsafe for optimization 
...
# TE <- teTrSettings$TE 
# TR <- teTrSettings$TR
# testDat <- phantomArr[1:10, 1:10, ]
# # testRes <- estimateImgPar(imageDat = testDat, TE = TE, TR = TR)
...
I can't tell if this text will actually above or below the actual code I ran, so here's that note: I removed a number of the failsafe/checks and ultimately went with the following. 
