...
>> 2. The National Institute of Standards and Technology has a web page that lists the first 5,000 digits of the irrational number $\pi$. You can read these digits into R from the website http://www.itl.nist.gov/div898/strd/univ/data/PiDigits.dat.
...
m per hour = miles per hour * (km/mile) * (m / km)
m stopping distance = feet stopping distance (1 km / ft) * (m / km)
