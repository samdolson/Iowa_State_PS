...
km per hour = miles per hour * (km/mile) 
km stopping distance = feet stopping distance (1 km / ft)


```{r}
metricSpeed <- cars$speed*1.6093
metricDistance <- cars$dist/3280.84
```
...
```{r}
plot(x = metricSpeed, y = metricDistance, xlab = "km/hour", ylab = "km stopping distance")
```
