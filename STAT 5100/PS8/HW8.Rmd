...
$P_1 = \mathbf{X}(\mathbf{X}^T \mathbf{X})^{-1} \mathbf{X}^T$

$P_2 = [\mathbf{X}\ \mathbf{Z}] \left( [\mathbf{X}\ \mathbf{Z}]^T [\mathbf{X}\ \mathbf{Z}] \right)^{-1} [\mathbf{X}\ \mathbf{Z}]^T$
...
Mean Squares are the same as Sum of Squares, because...
