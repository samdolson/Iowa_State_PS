...
Project Matrix 1: Overall Mean ($P_1$):
...
Projection Matrix 2: Treatment Means ($P_2$):
...
Projection Matrix 3: Subject Means ($P_3$):
...
Table listing source of variation, df, and expected mean squares
...
Cochran-Satterthwaite Df Approximation: 1.1019
