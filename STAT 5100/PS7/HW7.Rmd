...
Suppose the responses in problem 2 were sorted first by subject and then by drink into a response vector $y$; i.e.,
...
As given, the response vector would be given in vector notation as:

$$
y = [y_{11}, y_{21}, \cdots , y_{1,20}, y_{2,20}, y_{1,21}, \cdots , y_{1,40}, y_{2,41}, \cdots , y_{2,60}]'.
$$
