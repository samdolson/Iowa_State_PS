...
Both posterior distributions of $RR$ place nearly all their (respective) mass(es) above 1 and are centered somewhere in the range of values from 5 to 7. Relative to the sample estimate $\widehat{RR}\approx 6.69$, the plug-in summaries show mild shrinkage (from $RR(E[\theta])\approx 6.50$ to $RR(\tilde{\theta})\approx 6.04$). 

Importantly, the posterior probability that $RR>1$ is effectively 1 under both models:
