...
None of these transformations look especially great in terms of linear fit, though interpretation of the plots needs to account for the expected increase in variance as a function of the expectation. That being said, the log link doesn't seem especially bad (perhaps a 'least worst' among the transformations considered).  
