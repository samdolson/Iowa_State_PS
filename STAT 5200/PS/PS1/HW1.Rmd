...
$Y_1: \Omega \rightarrow \{0,1\}, \quad Y_1(\omega) \in \{0,1\}$

A R.V. for the number of mayflies (in a sample),  
$Y_2: \Omega \rightarrow \mathbb{N}_0, \quad Y_2(\omega) \in \mathbb{N}_0$
...
$X_1: \Omega \rightarrow \{\text{Backwater}, \text{Impounded Water}, \text{Side Channel}, \text{Main Channel Border}\}$

(Covariate) A R.V. for sediment type (3 shown for brevity),  
$X_2: \Omega \rightarrow \{\text{Sand}, \text{Silt}, \text{Clay}, \ldots\}$

(Covariate) A R.V. for year,  
$X_3: \Omega \rightarrow \{1992,\ldots,2004\}$
...
Where $N_i$ is a R.V. for the number of piglets born to sow $i$: $N_i: \Omega \to \mathbb{N}_0 \quad N_i(\omega) \in \mathbb{N_{0}}$

(Alternatively) We could also have a R.V. for the type of piglet $j$ born to sow $i$,

$$
Y_{ij}:\Omega \to \{\text{Normal},\ \text{Weak},\ \text{Stillborn}\} , \quad j=1,\dots,N_i,
$$

With support given by the set $\{\text{Normal},\ \text{Weak},\ \text{Stillborn}\}$ and where $N_i$ denotes the number of piglets born to sow $i$ (again).
