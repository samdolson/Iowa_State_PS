...
header-includes:
  ...
  - \fancyhead[R]{\LARGE STAT 5460 HW 1}
  - \fancyfoot[C]{\thepage}
...
meaning $O(1/n)=o\!\big(1/(n h^{2r+1})\big)$, such that the squared-mean term is negligible relative to the leading term from the first component of the variance decomposition. 
