...
(4): $K$ is differentiable with bounded derivative, $| K'|_\infty = \sup_{u\in\mathbb{R}} |K'(u)| < \infty$.

Note: Condition 4 implies the kernel density estimator (and its expectation) is Lipschitz continuous on $[a,b]$. This Lipschitz property enables the reduction from a supremum over a (possibly) infinite set to a maximum over a finite net.
