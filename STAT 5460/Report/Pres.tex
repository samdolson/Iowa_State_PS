...
\item
  \textbf{2020-2024} --- Kendall's \(\tau\) was used for ``match rate
  analysis'' to determine whether two separate processes replicate
  ``close enough'' healthcare metrics (my personal experience).
\item
...
structure of pairwise Kendall's \(\tau\)'s under independence (\(H_0\)).
