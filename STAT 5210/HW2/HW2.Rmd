...
We can turn back to our given Equation (13) using these known alternative expressions, specifically:
...
Additionally, for large $\gamma_1$, the term $\gamma_1^{-1} D_p^{-1}$ is negligible, and the expression simplifies to:
