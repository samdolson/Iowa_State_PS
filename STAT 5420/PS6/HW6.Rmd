...
$$
f_Y(y) = \int_{\lambda = 0}^\infty f_Y(y | \lambda) f_\Lambda(\lambda) d\lambda = \int_{\lambda = 0}^\infty \frac{\lambda ^{y}e^{-\lambda}}{y!} \frac{1}{\beta^{\alpha} \Gamma(\alpha)} \lambda^{\alpha - 1} e^{-\lambda / \beta} d \lambda
$$

$$
f_Y(y) = \frac{1}{y!\beta^{\alpha} \Gamma(\alpha)} \int_{\lambda = 0}^\infty \lambda ^{y}e^{-\lambda} \lambda^{\alpha - 1} e^{-\frac{\lambda}{\beta}} d \lambda = \frac{1}{y!\beta^{\alpha} \Gamma(\alpha)} \int_{\lambda = 0}^\infty\lambda^{y + \alpha - 1} e^{\frac{-\lambda}{\frac{\beta}{(1+\beta)}}} d \lambda
$$

Note the right-hand term is a Gamma function, i.e. for $u = \lambda(\frac{1+\beta}{\beta}) \rightarrow \lambda = u(\frac{\beta}{1 + \beta}) \rightarrow d\lambda = du (\frac{\beta}{1 + \beta})$ and we have: 

$$
f_Y(y) = \frac{1}{y!\beta^{\alpha} \Gamma(\alpha)} \int_{u = 0}^\infty u^{y + \alpha - 1} e^{-u} (\frac{\beta}{1+\beta})^{y + \alpha} du = \frac{1}{y!\beta^{\alpha} \Gamma(\alpha)} (\frac{\beta}{1+\beta})^{y + \alpha} \int_{u = 0}^\infty  u^{y + \alpha - 1} e^{-u} du = \frac{1}{y!\beta^{\alpha} \Gamma(\alpha)} (\frac{\beta}{1+\beta})^{y + \alpha} \Gamma(\alpha + y)
$$

Simplifying gives us: 

$$
f_Y(y) = {y + \alpha - 1 \choose y} \frac{\beta}{1 + \beta} \frac{1}{1 + \beta}
$$
...
However, we may also calculate it using conditional expectation, specifically: 
...
$$
Cov(X_1 - 2X_2, 3X_1 + X_2) = Cov(X_1, 3X_1) + Cov(X_1, X_2) - Cov(2X_2, 3X_1) - Cov(2X_2, X_2) = 3 Cov(X_1, X_1) + Cov (X_1, X_2) - 6 Cov(X_1, X_2) - 2 Cov (X_2, X_2)
$$

$$
Cov(X_1 - 2X_2 + 8, 3X_1 + X_2)  = 3 \sigma_1^2 - 5 \sigma_1\sigma_2 - 2 \sigma_2^2
$$
...
$$
E[Y^2] = \frac{\partial^2}{\partial t_2^2} M_{X, Y}(t_1, t_2) \Big|_{t_1 = 0, t_2 = 0} \frac{2}{t_1} \left( \frac{(1 - t_2)^3 - (1 - t_1 - t_2)^3}{(1 - t_1 - t_2)^3 (1 - t_2)^3} \right) = \frac{2}{t_1} \left( \frac{3t_1}{(1 - t_1 - t_2)^3 (1 - t_2)^3}\right) = \frac{2}{t_1} \frac{t_1(t_1^2 - 3t_1 + 3 - 6t_2 + 3t_1t_2 + 3t_2^2)}{(1 - t_1 - t_2)^3 (1 - t_2)^3}
$$

$$
E[Y^2] =  \lim_{t_1 \to 0, t_2 \to 0} \frac{2}{t_1} \frac{t_1(t_1^2 - 3t_1 + 3 - 6t_2 + 3t_1t_2 + 3t_2^2)}{(1 - t_1 - t_2)^3 (1 - t_2)^3} = \lim_{t_1 \to 0, t_2 \to 0} \frac{6}{(1 - t_1 - t_2)^3 (1 - t_2)^3} = \lim_{t_1 \to 0, t_2 \to 0} \frac{6}{(1 - 0 - 0)^3 (1 - 0)^3} = \frac{6}{1} = 6
$$
