...
So, $Var(X) = 1, Var(Y) = 1, \text{ and } Cov(X, Y) = 1$.
...
$$
M_X(t_1) = M_{X, Y}(t_1, 0) = \frac{1}{t_1} \left( \frac{1}{1 - t_1} - 1 \right) = \frac{1}{t_1} \left( \frac{1}{1 - t_1} - 1 \right) = \frac{1}{t_1} \left( \frac{1 - (1 - t_1)}{1 - t_1} \right) = \frac{t_1}{t_1(1 - t_1)} = \frac{1}{1 - t_1}
$$
...
Similarly, for the marginal MGF of X, we set $(t_1, t_2) = (0, t_2)$:
