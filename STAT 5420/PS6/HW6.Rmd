...
$$
f_Y(y) = \frac{1}{y!\beta^{\alpha} \Gamma(\alpha)} \int_{\lambda = 0}^\infty \lambda ^{y}e^{-\lambda} \lambda^{\alpha - 1} e^{-\frac{\lambda}{\beta}} d \lambda
$$

$$
f_Y(y) = \frac{1}{y!\beta^{\alpha} \Gamma(\alpha)} \int_{\lambda = 0}^\infty\lambda^{y + \alpha - 1} e^{\frac{-\lambda}{\frac{\beta}{(1+\beta)}}} d \lambda
$$
...
$$
f_Y(y) = \frac{1}{y!\beta^{\alpha} \Gamma(\alpha)} \int_{u = 0}^\infty u^{y + \alpha - 1} e^{-u} (\frac{\beta}{1+\beta})^{y + \alpha} du
$$

$$ 
f_Y(y) = \frac{1}{y!\beta^{\alpha} \Gamma(\alpha)} (\frac{\beta}{1+\beta})^{y + \alpha} \int_{u = 0}^\infty  u^{y + \alpha - 1} e^{-u} du = \frac{1}{y!\beta^{\alpha} \Gamma(\alpha)} (\frac{\beta}{1+\beta})^{y + \alpha} \Gamma(\alpha + y)
$$
