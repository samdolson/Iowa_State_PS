...
$$\mathbb{d}(F(x)) / \mathbb{dx} = \mathbb{d}((1+x)/2) / \mathbb{dx} = \frac{1}{2}$$
  ...
  $$P(X > \frac{1}{2}) = 1 - F(\frac{1}{2}) = 1 - P(X \leq \frac{1}{2}) = 1 - ((1 + \frac{1}{2})/2) = 1 - \frac{3}{4} = \frac{1}{4}$$
  
  $$P(X \geq \frac{1}{2}) = 1 - F(\frac{1}{2}) + f(\frac{1}{2}) = P(X > \frac{1}{2}) + P(X = \frac{1}{2}) = \frac{1}{4}+\frac{1}{2} = \frac{3}{4}$$
  
  $$P(0 < X \leq \frac{1}{2}) = F(\frac{1}{2}) - F(0)= P(X \leq \frac{1}{2}) - P(X \leq 0) = \frac{3}{4} - \frac{1}{2} = \frac{1}{4}$$
  
  $$P(0 \leq X \leq \frac{1}{2})= P(0 < X \leq \frac{1}{2}) + P(X=0) = \frac{1}{4} + \frac{1}{2} = \frac{3}{4}$$
...
$$f_Y(y) = \frac{3}{8}(1-y)^{-1/2} + \frac{3}{8}(1-y)^{1/2}$$
...
(1): 
$$\frac{3}{8}((1-y)^{1/2} + 1)^2\frac{1}{2}(1-y)^{-1/2} = \frac{3}{16}(1-(1-y)^{1/2})^2(1-y)^{-1/2}$$
...
$$f_Y(y) = \frac{3}{16}(1-(1-y)^{1/2})^2(1-y)^{-1/2} + \frac{3}{8}(2-y)^{2}$$
