...
But realistically, the computer program defined above for the Uniform(0,1) distribution can be transformed using a particular function to convert the numbers to a new scale ($-\infty, \infty$), where, for example $u=\frac{1}{2} \rightarrow z = 0$. I am hesitant to say the above is a method for doing so, but honestly I just followed the Hint to what I believed to be its natural conclusion. 
