...
And the lambda term (alternative parametrization) just changes the interpretation of what the lambda signifies. The first (primarily used in the problem) is parametrizing the parameter as the "scale parameter", whereas the alternative note given is for when we interprete it as the "rate parameter". 
