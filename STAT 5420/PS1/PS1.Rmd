...
Let $A, B \in \mathbb{B}$ and assume Countable Additivity (1). 
...
1.2.9:  $P(A \cup B) = P(A) + P(B) - P(A \cap B)$
...
Notes: https://math.stackexchange.com/questions/2419485/probability-question-in-a-certain-family-four-girls-take-turns-at-washing-dish

The probability that three from four dishes were randomly broken by the same girl is 3/16

The probability that three from four dishes were randomly broken by the youngest girl is 3/64

4^4 possible arrangements 

(a) Find the probability that child a breaks 3 plates. 

4 choose 3: 4 children, choose one child to break 3 dishes
Probability(one child breaks 3 dishes) (1/4 ^ 3)
Probability(any of the other children break 1 dishes) (3/4)



(b) Find the probability that one of the four children breaks 3 plates. 

4 choose 1: 4 children, choose 1 
4 choose 3 : 4 children, choose 3 
Probability(one child breaks 3 dishes) (1/4 ^ 3)
Probability(any of the other children break 1 dishes) (3/4)
...
To prove a function is a (valid, proper) cdf, we must verify: 

(1): $\lim_{x \rightarrow -\infty}{F(x) = 0}$ and $\lim_{x \rightarrow \infty} F(x) = 1$

(2): $F(x)$ is a nondecreasing function of x. 

(3): $F(x)$ is right-continuous; that is, for every number $x_0$, $\lim_{x \downarrow x_0}{F(x) = F_o}$
