...
Notes: 
https://math.stackexchange.com/questions/514135/why-distribution-function-is-right-continuous
...
$$A_n = \lim_{n \rightarrow \infty} A_n = \lim_{n \rightarrow \infty} \{ X \leq x + n^{-1}\} = \{ X \leq x \}$$

Evaluating the associated probabilities gives us: 

$$P(\bigcap\limits_{i=1}^{\infty}A_i) = \lim_{n \rightarrow \infty}{P(A_n)}  = P(\{ X \leq x \})  = F(x)$$
