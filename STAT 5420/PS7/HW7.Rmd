...
$$
\text{E}(V \mid W = w) = \mu_V + \frac{Cov(V, W)}{Var(W)} (w-\mu_W) = \mu_V + \frac{Cov(V, W)}{Var(W)} (w-0) = \frac{1}{2} w
$$

$$
\text{E}(V \mid W = w) = \mu_V + \frac{Cov(V, W)}{Var(W)} w = 0 + \frac{Cov(V, W)}{Var(W)} w = \frac{1}{2} w
$$
