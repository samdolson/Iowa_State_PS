...
$$\mu = \frac{2z_{\alpha + \frac{1}{2}} - 6z_{\alpha}}{(z_{\alpha + \frac{1}{2}} - z_{\alpha})}$$
...
Note, given the relations of $\mu, \sigma$, there are many possible solutions (values of $z_\alpha, z_{\alpha+\frac{1}{2}}$) that satisfy the desired property $P(|X|< 2) = \frac{1}{2}$, so we conclude the values that satisfy are not unique. 
