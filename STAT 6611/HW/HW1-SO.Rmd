...
## Relevant sections — STAT 714 Lecture Notes (Tebbs)

**Primary — generalized inverse theory**

- **§7.4, Systems of equations** (p. 128) — the $AGA=A$ definition, existence of a generalized inverse for any matrix, general-solution formula $x = A^-y + (I-A^-A)z$.
- **§7.5, Perpendicular projection matrices** (p. 134) — $P_X = X(X'X)^-X'$: idempotent, symmetric, unique, invariant to choice of g-inverse.
- **Ch. 2, §2.1–2.2, The Linear Least Squares Problem** (pp. 13–24) — normal equations $X'X\hat\beta=X'Y$; Results 2.6–2.8 (construction and properties of $P_X$) as a worked application.

**Supporting background**

- **§7.1–7.3, Matrix algebra basics, rank, vector spaces** (pp. 118–127) — $\mathcal{C}(\cdot)$/$\mathcal{N}(\cdot)$ notation, rank facts (e.g. $\operatorname{rank}(AB)\le\operatorname{rank}(A)$).
- **§7.6, Trace, determinant, and eigenproblems** (p. 136) — spectral decomposition $A=PDP'$, used in symmetric-g-inverse constructions.

**Not needed for this topic:** Ch. 1, 3–6 (linear model examples, estimability, Gauss-Markov theory, distribution theory, testing) — build on generalized inverses rather than developing the theory itself.
