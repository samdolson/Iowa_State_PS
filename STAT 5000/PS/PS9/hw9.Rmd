...
We observe the two fit lines to be remarkably close to one another. Suggesting that despite removing an obvious outlying point, the overall impact that point had on our predicted best fit line was negligible. 
...
$$
\mathbf{X} = \begin{bmatrix} 1 & X_1 \\ 1 & X_2 \\ 1 & X_3 \\ 1 & X_4 \end{bmatrix}
$$
...
$$
\hat{Y} = b_0 + b_1 x_i = -229.94 + 3612.50x_i
$$
...
We are 95% confident, that the true estimated mean price for diamonds weighting 0.2g is between \$475.46 to \$509.66. 
...
We are 95% confident, that the true estimated mean price for diamonds weighting 0.3g is between \$730.56 to \$977.05. 
