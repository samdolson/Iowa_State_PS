...
Observational, as patients volunteered for the treatment and the treatment was selected (randomly) for the participants. 
...
The response variable is the survival time of the patients, specifically whether a patient died.
...
```{r Title, echo=FALSE, fig.cap="Title", out.width = '100%'}
...
Low probability that under the null hypothesis we observed the results we did; we have evidence to reject the null hypothesis that there is no difference between the two groups. 
