...
I recommend switching to an RCBD with row blocks, as it simplifies the design while still accounting for a potentially significant source of variability in the study, this source being from row block effects. 
