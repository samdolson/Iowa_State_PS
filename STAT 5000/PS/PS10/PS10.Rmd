...
#### Residuals Plot:
  ...
  - The aforementioned point is conditional on the removal of outliers. There are a few points that could be outliers in the data, such that their removal would provide a residual plot that looks good, i.e. conforms to our expectations were our assumptions (of linearity and of equal variances) not being violated.
...
#### Normal Q-Q Plot:
  ...
  - Again, we do observe some points that could be considered outliers, such that their possible removal would help to further validate our assumptions are not being violated.
