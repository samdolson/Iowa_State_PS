...
The Confideence Interval is (0, -0.329). 

\newpage

> 2.  Interpret the confidence interval in the context of the study.

We are 95% confident that the true difference in blood cholesterol levels between those who consumed Brand A vs. Brand B is between 0 and -.329; we are 95% confident the true difference between consuming Brand A to consuming Brand B is between 0 and -.329 (or that there is no difference to a slightly lower cholesterol level for those who consume Brand A). 
...
$$n_0 = 8(\frac{t_{2(n_0-1),1-\frac{\alpha}{2}}S_p}{w})^2$$
...
$n_0 = 491.7248 \rightarrow t_{492, 0.975} \approx  1.984$ (rounding down to df=100)
(1.9653?)

Note: Used this https://www.meracalculator.com/math/t-distribution-critical-value-table.php
...
The sample size needed is 495 participants per group. 
