...
From the studentized residual plot, there appear to be many outliers (studentized residuals exceed 2). From the leverage plot, there appears to be many high leverage points (exceeding 2*(8+1)/50000 = 0.00036). From the cook’s D plot, there appear to be several high influence points (exceeding
