...
(i): Test Statistic: F: 11.350

(ii): Critical value of F: $F_{{r-1},{N-r},{1-\alpha}} = 1.989$

(iii): 

$F_{Scheffe} = (9-1) (1.989) = 8(1.989) = 15.91$

Since the test statistic (11.350) is less than the Scheffe critical value (15.912), the difference is not significant under the Scheffe method.
