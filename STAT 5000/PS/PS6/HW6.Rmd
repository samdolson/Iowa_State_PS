...
$$t_{{N-r},{1-\alpha/2}} = 1.973, t_{{N-r},{1-\alpha/(2m)}} = 3.246, F_{{r-1},{N-r},{1-\alpha}} = 1.989, F_{{1},{N-r},{1-\alpha/2}} = 5.107$$
\newpage
## (a) 
