...
5. Kiln Temperature 1 (p-value = 0.2348): We do not have evidence at the $\alpha = 0.05$ level to reject the null hypothesis that average amylase activity for kiln temperature of 100F compared to average amylase activity for kiln temperature of 100F to 130F is the same, despite the estimated effect of the 100F kiln temperature (temperature of kiln staying constant at 100F) improving the efficiency of the malt usage for C02 production (estimated a not statistically significant 16.13 units decrease). 
