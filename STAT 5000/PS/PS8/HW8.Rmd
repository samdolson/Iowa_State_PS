...
Q1 (a) && Q2 (f): Need to do factor-level effect interpretations, or general "treatment effect" interpretations? 

Q2 (g): Examine a profile plot of the treatment means (do not hand it in). Just want to double check this. 

Q3 (b), (c): 2k factorial study, interpret like a SLR and not like an ANOVA? 

Q3 study design: Correct interpretation, want lower response variable values. Higher response means lower efficiency which is not what we want? Can we also invert an interpretation, i.e. using A v. B to using B v. A? 
...
Keep in mind that low values of the response variable correspond to combinations of factors that produce 204.7 ml of CO2 with the least amount of malt.
