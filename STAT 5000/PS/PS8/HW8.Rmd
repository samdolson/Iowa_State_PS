...
Treatment Design: We have 2 factors each with 3 levels, so it's a 3×3 factorial arrangement (3 distinct Species by 3 distinct Filter Types). This is also a Full factorial treatment design as every combination (all possible cell means) have at least one observation. 
