...
I also added a Levene test for homogeneity of variances and reported it below. This test affirms the above assessment, insomuch as it provides a large(ish) p-value in support of its associated null hypothesis of homogenous (equal) variances between groups. 
