...
```{r}
hist(minn_radon$radon[minn_radon$county=="OLMSTED"], xlab = "Box-Cox Transformed Radon Levels", main = "OLMSTED", freq = FALSE, ylim = c(0, 0.2))
lines(density(minn_radon$radon[minn_radon$county=="OLMSTED"]), col = "black", lwd = 2)
```

```{r}
hist(minn_radon$radon[minn_radon$county=="STEARNS"], xlab = "Box-Cox Transformed Radon Levels", main = "STEARNS", freq = FALSE)
