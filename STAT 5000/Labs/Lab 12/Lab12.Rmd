...
# Outline
  ...
  - Q1, part (e), "unique without constraints"?
  - Q2, part (b), do we need "uncorrelated errors"? 
...
### Alternative, no constraints imposed: 
...
$$
E(Y_{i,2,k}) - E(Y_{i,3,k}) = [\mu + \alpha_i + \tau_2 + (\alpha \tau)_{i,2}] - [\mu + \alpha_i + \tau_3 + (\alpha \tau)_{i,3}]
$$
