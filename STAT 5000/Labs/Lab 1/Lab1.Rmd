...
The shape of the above distribution is approximately normal centered at mean 0. There appears to be near zero in both skewness and kurtosis as well, and the variability of the distribution appears even about the mean (roughly equal number of values greater than 0 as there are values less than 0); I believe this corresponds to $\sigma \approx 2$, $\sigma^2 = 4$.
